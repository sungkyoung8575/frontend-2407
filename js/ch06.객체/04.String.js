...
// 문자열 일부분(substring)
let today = new Date().toISOString();       // 2024-07-19T02:12:59.447Z
console.log(today);
// 날짜추출 - 2024-07-19
...
console.log(new Date().toLocaleString());           // 2024. 7. 19. 오전 11:21:33
console.log(new Date().toLocaleString().substring(16));     // 인덱스 16부터 끝까지

// 공백 제거
let space = '\t   Hello?      \r\n ';
console.log(space.trim());          // 양쪽의 White space: 공백, 탭, /r , /n
